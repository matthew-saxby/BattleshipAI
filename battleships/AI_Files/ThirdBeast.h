/**
 * @file ThirdBeast.h
 * @author Matthew Saxby David Celisti
...
class ThirdBeast: public Player {
    ...
    private:
        ...
        //history shot board
        void create_shot_count_board();
        int **shot_count_board;
        int count_remaining_enemy_ships();
        ...
        // prob_board stuff for horizontal and vertical values
       int hVal(int row, int col);

       //VERTICAL NOW
       int vVal(int row, int col);

       static int game_number;
        
       //bonus
       //int calculateBonus(int distance);
